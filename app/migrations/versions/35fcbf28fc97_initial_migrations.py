...
Revision ID: 35fcbf28fc97
Revises: 
Create Date: 2018-06-10 16:07:29.398609
...
def upgrade():
    ...
    sa.Column('follow_method', sa.Enum('APPLE', 'SPOTIFY', name='followmethod'), nullable=True),
    sa.ForeignKeyConstraint(['artist_mbid'], ['artist.mbid'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    ...
    sa.Column('release_mbid', sa.String(length=36), nullable=False),
    sa.Column('date_added', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('add_method', sa.Enum('AUTOMATIC', 'MANUAL', name='addmethod'), nullable=True),
