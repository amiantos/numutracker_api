...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("import_name", sa.Text(), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_artist_import_user_id"),
        "user_artist_import",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_user_notification_date_created"),
        "user_notification",
        ["date_created"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_notification_type"), "user_notification", ["type"], unique=False
    )
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "import_name", sa.VARCHAR(length=100), autoincrement=False, nullable=False
        ),
        sa.Column(
            "import_mbid", sa.VARCHAR(length=36), autoincrement=False, nullable=True
        ),
        sa.Column(
            "import_method", sa.VARCHAR(length=36), autoincrement=False, nullable=True
        ),
        sa.Column(
            "found_mbid", sa.VARCHAR(length=36), autoincrement=False, nullable=True
        ),
        sa.Column(
            "date_added",
        ...
        sa.ForeignKeyConstraint(
            ["found_mbid"],
            ["artist.mbid"],
            name="artist_import_found_mbid_fkey",
            onupdate="CASCADE",
            ondelete="SET NULL",
            initially="DEFERRED",
            deferrable=True,
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["user.id"],
            name="artist_import_user_id_fkey",
            onupdate="CASCADE",
            ondelete="CASCADE",
            initially="DEFERRED",
            deferrable=True,
    ...
    op.create_index(
        "ix_artist_import_user_id", "artist_import", ["user_id"], unique=False
    )
    op.create_table(
        "user_notifications",
        sa.Column("user_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "release_mbid", sa.VARCHAR(length=36), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["release_mbid"],
            ["release.mbid"],
            name="user_notifications_release_mbid_fkey",
            onupdate="CASCADE",
            ondelete="CASCADE",
            initially="DEFERRED",
            deferrable=True,
        ...
        sa.PrimaryKeyConstraint(
            "user_id", "release_mbid", name="user_notifications_pkey"
        ),
    )
    op.create_index(
        "ix_user_notifications_type", "user_notifications", ["type"], unique=False
    )
    op.create_index(
        "ix_user_notifications_date_created",
        "user_notifications",
        ["date_created"],
        unique=False,
    )
    ...
    op.drop_index(
        op.f("ix_user_notification_date_created"), table_name="user_notification"
    )
    op.drop_table("user_notification")
    op.drop_index(
        op.f("ix_user_artist_import_user_id"), table_name="user_artist_import"
    )
